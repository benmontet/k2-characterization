...
On the other hand, we find that 21 candidates
have FPP $<$ 1\%.  
Two of these we find to be caused by systematics
...
solely on the transit photometry and SDSS data, with no need for follow-up imaging.  This
...
We show the transit signals in Fig. \ref{fig:transits}.
...
To investigate the possibility that such wide companions exist, we
query the ninth data release of the Sloan Digital Sky Survey
\citep[SDSS DR9,][]{Ahn12} for all stars within 25\arcsec\ with
$\Delta r < 8$ relative to each object of interest.  
Each such companion star has a ``maximum depth'' that it could cause
as a diluted ``transit'' signal, corresponding to a total eclipse 
of the hypothetical 
background binary system, inducing a 50\% flux decrement in the 
background star's apparent brightness.
Table 5 lists the 11 such stars (plus one detected in AO imaging),
whose maximum depth is at least as deep 
as the observed transit depth, thus making them possible contaminants.
...
candidates: 201295312.01, 201403446.01, 201546283.01, 201828749.01.  Despite receiving
