...
We apply a uniform prior ranging from zero to a maximum extinction value of 0.2 
(a conservative upper limit for a field at such high Galactic latitude), and
...
we exclude these candidates (EPIC 201929294 and EPIC 201555883) from the Table
of results.
}
...
In this work, we use
\texttt{vespa}\footnote{\url{http://github.com/timothydmorton/vespa}} \citep{vespa},
a new publicly available, general-purpose implementation
of the \citet{Morton12} procedure,
