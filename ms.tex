...
Timothy D. Morton\altaffilmark{4},
% The Benefactors
John Asher Johnson,
David W. Hogg,
% The Observers
...
\altaffiltext{4}{Department of Astrophysics, 4 Ivy Lane, Princeton University, Princeton, NJ 08544, USA}
...
While we do have follow-up observations of a number of these systems,
we do the preliminary FPP calculations without taking these into account,
relying solely on the probabilistic \texttt{vespa} analysis.
...
probabilities (FPPs) $>$90\%; these we consider to be likely false
positives.  
