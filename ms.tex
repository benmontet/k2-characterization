...
\title{Stellar and Planetary Properties of \KT\ \Ci\
...
Tables 2 and 3. The former lists parameters derived from photometry with
un-inflated uncertainties, while the latter includes this inflating intended to
encapsulate the effect of model uncertainties.
...
In Table 6, the ``maximum depth'' column represents
...
\include{table_stellarprops_inflated}
