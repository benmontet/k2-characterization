...
\newcommand{\Nlimbo}{10} %adds to 36?  good.
...
\author{%
% The Heavy Lifters
Benjamin~T.~Montet\altaffilmark{1,\caltech,\cfa},
...
\altaffiltext{1}         {btm@astro.caltech.edu}
...
scenarios:
\begin{itemize}
\item A chance-aligned eclipsing binary system may reside within
a sky area equivalent to 8 arcsecond radius of the target star.
...
\item High-resolution imaging constraints, where available (see below)
\end{itemize}
