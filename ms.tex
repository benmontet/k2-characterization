...
of these measurements is adopted for our final values listed in Table~XX.
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.5\textwidth]{f3}}
...
\anytodo{201828749 has an AO companion, flux ratio 6:1 or so. We call it a planet.
It's a very flat bottom thing, with fairly short ingress and egress: the transit shape
is way more planet than EB so I'm comfortable with this designation. We need
...
\begin{figure*}[htbp]
\centerline{\includegraphics[width=1.0\textwidth, trim=0 6.30cm 0 6.30cm, clip=true]{f4}}
