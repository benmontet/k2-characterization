...
as discussed in \ref{sec:AO}. \btmtodo{More text...}
...
The PHARO AO system has a field of view of NUMBER arcseconds.
\btmtodo{Check with Brendan to find this number}.
...
\begin{figure*}[htbp]
\centerline{\includegraphics[width=1.0\textwidth, trim=0 6.30cm 0 6.30cm, clip=true]{f3}}
